...
public class AssertionPrgm extends Base{
	@Test
  public void assertEqualsTest() {
	...
	public void assertNotEqualsTest() {
		...
		String actualstring=driver.getTitle();
		System.out.println(actualstring);
		String expected="Most Reliable AApp & Cross Browser Testing Platform | BrowserStack";
	...
	public void assertFalseTest() {
		driver.navigate().to("https://www.browserstack.com/");
		boolean verifytitle =driver.getTitle().equalsIgnoreCase("Most Reliable AApp & Cross Browser Testing Platform | BrowserStack");
	...
	public void assertNotNullTest() {
		driver.navigate().to("https://www.browserstack.com/");
		boolean verifyassert=driver.getTitle().equalsIgnoreCase("Most Reliable AApp & Cross Browser Testing Platform | BrowserStack");
